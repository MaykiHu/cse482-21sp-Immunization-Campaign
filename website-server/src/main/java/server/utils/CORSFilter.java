/*
 * Credit to Spring 2020 CSE 331 server material, with modification for
 * class project on campaign planning to run a server
 */
...
/**
 * Credit to Spring 2020 CSE 331 server material, with modifications to start
 * our own local server project
 */
public class CORSFilter {
    ...
    public void apply() {
        ...
        //
        Logger logger = LoggerFactory.getLogger("Campaign Planning Server");
